...
export const Selector = () => {
    ...
    const getArticulos = (fijaciones) => {
        fijaciones.map(fijacion => {
            ...
            fetch("https://preprod.shad.es/wc-api/v3/products?filter[sku]=" + fijacion.SKU + "&consumer_key=ck_ba8c741efe83858f8d748707026f0a933d3c486c&consumer_secret=cs_cfe7fd819bc78fac8522cd37fba51a3f4c0261da", { mode: 'no-cors'})
